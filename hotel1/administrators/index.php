<?php
    ...
    $sql = "SELECT * FROM authentication_page WHERE username= '$username_fake' LIMIT 1";
    ...
    if($password_fake == $db_password) {
        ...
        $_SESSION['id'] = $id;
        $_SESSION["authentication_page"] = 'authentication_page';
        header("Location: employee/");
    } else {
        echo "<br>";
        header("Location: access_denid.html");
    }
